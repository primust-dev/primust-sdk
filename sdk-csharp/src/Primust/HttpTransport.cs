...
internal class HttpTransport
{
    ...
    public virtual Task<Dictionary<string, object?>?> PostOpenRunAsync(
        Dictionary<string, object?> payload)
        => PostAsync("/runs", payload);

    public virtual Task<Dictionary<string, object?>?> PostRecordAsync(
        string runId, Dictionary<string, object?> envelope)
        => PostAsync($"/runs/{runId}/records", envelope);

    public virtual Task<Dictionary<string, object?>?> PostCloseRunAsync(
