...
### v12.0 · March 15, 2026 · Supersedes DECISIONS v11.0 and all prior versions
...
>
> DECISIONS_v12 incorporates: DECISIONS_v11 + CANONICAL_AMENDMENTS_v12_v8_v7 + AIUC-1 schema additions + Unstructured Check Handling Spec v1.0 + March 15, 2026 session decisions.
...
> ⚠ Do NOT use: PEC, PGC, byollm, proof_profile, coverage_pct, Execution+ZKML, TrustScope branding in any Primust code, doc, or customer-facing material.
...
|---|---|---|---|---|---|
| Mathematical | mathematical | Noir, UltraHonk, Modal CPU | None — math | Regex, allowlist, threshold, GARCH, OLS, policy rules (OPA/Cedar/Drools), Ed25519 verify | Built |
...
| Dashboard (Next.js 15 / React 19) | Built. 12 components, 6 tests. app.primust.com. GREEN. |
| Verify Site (Next.js 15) | Built. 3 components. verify.primust.com. GREEN. |
...
primust-cedar, primust-drools, primust-odm (Maven Central), primust-opa (pkg.go.dev — GREEN, go.mod fixed)
...
zk-worker (Modal Python), db (8 migrations), rules-core (Java), rules-core-go
...
| Maven Central | primust-cedar, primust-drools, primust-odm, sdk-java | Published |
...
- verify.primust.com: GCP KMS keys + service account deploy to Fly.io
- Migration 009: written, applies prompt fields to policy_snapshots
...
| primust-hook binary | 3 | BUILT — AMDT-16 resolved, Go binary, 31 tests |
...
**RESOLVED — See DECISION_hook_binary_amdt16.md. Binary built at packages/primust-hook/.**
...
## 22. GAP TAXONOMY — 30 TYPES (CANONICAL)
...
*DECISIONS_v12.0 · March 15, 2026 · Primust, Inc.*
*Supersedes DECISIONS_v11.0 + all prior versions and amendments.*
