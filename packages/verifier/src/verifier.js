...
import { canonical, verify as ed25519Verify, validateArtifact, fromBase64Url, } from '@primust/artifact-core';
...
export async function verify(artifact, options = {}) {
    ...
    if (tsAnchor && tsAnchor.type === 'rfc3161' && typeof tsAnchor.value === 'string') {
        result.timestamp_anchor_valid = verifyTimestampImprint(tsAnchor.value, documentBody);
