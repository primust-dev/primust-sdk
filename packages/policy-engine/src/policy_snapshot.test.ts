...
import type { PolicyPack, CheckManifest } from '@primust/runtime-core';
...
function makePolicyPack(manifestIds: string[]): PolicyPack {
  return {
...
describe('PolicySnapshotService', () => {
  ...
  let policyPacks: Map<string, PolicyPack>;
