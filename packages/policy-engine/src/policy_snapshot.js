...
export class PolicySnapshotService {
    ...
    registry;
    policyPacks;
    constructor(store, registry, policyPacks) {
        this.store = store;
    ...
    openRun(params) {
        ...
        for (const check of pack.checks) {
            ...
            let actionUnitCount = check.action_unit_count;
        ...
        const sortedChecks = [...effectiveChecks].sort((a, b) => a.check_id.localeCompare(b.check_id));
...
//# sourceMappingURL=policy_snapshot.js.map