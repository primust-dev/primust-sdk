...
const WITNESSED_GAP_TYPES = [
    {
        ...
        severity: "Critical",
        description: "The reviewer's Ed25519 signature could not be verified against the registered public key. " +
            "This may indicate a compromised key or incorrect signing process.",
    },
    {
        type: "witnessed_display_missing",
        severity: "High",
        description: "The witnessed record is missing display_hash. Without it, there is no proof of " +
            "what the reviewer actually saw during their review.",
    },
    {
        type: "witnessed_rationale_missing",
        severity: "High",
        description: "The witnessed record is missing rationale_hash. Without it, there is no proof of " +
            "the reviewer's reasoning for their approval decision.",
    },
];
export function ReviewerGuide() {
    return (<div className="max-w-3xl mx-auto p-6 space-y-8" data-testid="reviewer-guide">
      ...
      <section data-testid="proof-levels-section">
        ...
        <div className="space-y-3">
          {PROOF_LEVELS.map((pl) => (<div key={pl.level} className="border rounded p-3" data-testid={`proof-level-guide-${pl.level}`}>
      ...
      <section data-testid="key-privacy-section">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded p-4">
          ...
          <p className="text-sm text-amber-700 mt-1" data-testid="key-never-sent">
      ...
      <section data-testid="witnessed-gaps-section">
        ...
        <div className="space-y-3">
          {WITNESSED_GAP_TYPES.map((gap) => (<div key={gap.type} className="border rounded p-3" data-testid={`gap-doc-${gap.type}`}>
              <div className="flex items-center gap-2">
                <span className="font-mono text-sm">{gap.type}</span>
                <span className={`text-xs px-2 py-0.5 rounded ${gap.severity === "Critical"
...
//# sourceMappingURL=ReviewerGuide.js.map