export const metadata = {
    ...
    description: "Verify VPEC credentials. No login required. No data sent to any server.",
};
      ...
      <body className="bg-white text-gray-900 min-h-screen">
        <nav className="border-b px-6 py-3 flex items-center justify-between text-sm">
          ...
          <div className="flex gap-4 text-gray-500">
            ...
            <a href="https://docs.primust.com" className="hover:text-gray-900" target="_blank" rel="noopener noreferrer">
              Docs
            </a>
          </div>
        </nav>
