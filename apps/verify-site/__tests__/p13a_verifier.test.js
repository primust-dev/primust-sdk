...
describe("P13-A: verify.primust.com", () => {
    it("MUST PASS: valid VPEC shows valid", () => {
        ...
        expect(screen.getByTestId("valid-banner").textContent).toContain("Signature valid");
        // Landing summary should show
        expect(screen.getByTestId("landing-summary")).toBeInTheDocument();
        expect(screen.getByTestId("landing-summary").textContent).toContain("vpec_abc123");
    ...
    it("MUST PASS: tampered artifact shows invalid", () => {
        ...
        expect(screen.getByTestId("invalid-banner").textContent).toContain("Verification failed");
...
//# sourceMappingURL=p13a_verifier.test.js.map