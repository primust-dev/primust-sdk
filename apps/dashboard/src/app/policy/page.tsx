...
export default function PolicyPage() {
  ...
  function handleSelectBundle(bundle: PolicyBundle) {
    setSelectedBundle(bundle);
  }

  function handleActivateBundle(_bundleId: string) { // eslint-disable-line @typescript-eslint/no-unused-vars
        ...
        <div className="rounded border bg-white p-6" data-testid="bundle-detail-panel">
          {selectedBundle ? (
            <BundleDetail
              ...
              onSelectBundle={handleActivateBundle}
            />
          ) : (
