 ...
 */
export function WaiverForm({ gapId, onSubmit }: WaiverFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4" data-testid="waiver-form">
      <div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full border rounded p-2 text-sm"
          data-testid="waiver-compensating-control"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          max={maxDateStr}
          className="w-full border rounded p-2 text-sm"
          data-testid="waiver-expires-at"
        />
      </div>

      {error && (
        <div className="text-red-600 text-sm" data-testid="waiver-error">
          {error}
        </div>
      )}
