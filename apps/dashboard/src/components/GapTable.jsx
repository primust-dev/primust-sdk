...
export function GapTable({ gaps }) {
    ...
    return (<table className="w-full text-sm" data-testid="gap-table">
      <thead>
      ...
      <tbody>
        {sorted.map((gap) => (<tr key={gap.gap_id} className={gap.severity === "Critical" ? "bg-red-50" : ""} data-testid={`gap-row-${gap.gap_type}`}>
...
//# sourceMappingURL=GapTable.js.map