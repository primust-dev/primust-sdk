 ...
 */
export function CoverageDisplay({ policyCoveragePct, recordsPass, recordsTotal, instrumentationSurfacePct, instrumentationSurfaceBasis, scopeType, coverageVerifiedPct, coveragePendingPct, coverageUngovernedPct, }) {
    return (<div className="space-y-3" data-testid="coverage-display">
      ...
      <div data-testid="surface-denominator">
        ...
        {instrumentationSurfacePct !== null ? (<>
            ...
            {instrumentationSurfaceBasis && (<span className="text-gray-500 ml-1">
      ...
      <div data-testid="coverage-buckets">
        <div className="flex h-4 rounded overflow-hidden">
          {coverageVerifiedPct > 0 && (<div className="bg-green-600" style={{ width: `${coverageVerifiedPct}%` }} data-testid="bucket-verified"/>)}
          {coveragePendingPct > 0 && (<div className="bg-yellow-400" style={{ width: `${coveragePendingPct}%` }} data-testid="bucket-pending"/>)}
          {coverageUngovernedPct > 0 && (<div className="bg-gray-300" style={{ width: `${coverageUngovernedPct}%` }} data-testid="bucket-ungoverned"/>)}
        </div>
...
//# sourceMappingURL=CoverageDisplay.js.map