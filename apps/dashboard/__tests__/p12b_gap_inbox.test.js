...
function makeGap(type, severity = "High", details = {}) {
    return {
        gap_id: `gap_${type}`,
        gap_type: type,
        severity,
...
describe("P12-B: Gap Inbox + Waiver Flow", () => {
    ...
    it("MUST PASS: Critical gaps display in red at top of inbox", () => {
        ...
        expect(rows[0]).toHaveAttribute("data-testid", "gap-inbox-row-gap_enforcement_override");
    });
});
//# sourceMappingURL=p12b_gap_inbox.test.js.map